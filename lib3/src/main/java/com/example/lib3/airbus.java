...
public class airbus {
    protected String name = "Airbus A320";
    public double wingArea = 124;
    public double aspectRatio = 10.3;
    public double thrust = 115000;
    public double CL_Max = 1.85;
    public double CL_G = 0.55;
    public double CD0 = 0.030;
    public double e = 0.77;
    public double CR = 0.020;
    public double carryWeight;
    public double maxWeight = 78000;
    public double emptyWeight = 42600;
    ...
    public airbus(double[] array, double newCarryWeight) {
    ...
    public double takeoffVel() {
        ...
        System.out.println(airDensity);
        System.out.println(vStall);
        return 1.25 * vStall;
